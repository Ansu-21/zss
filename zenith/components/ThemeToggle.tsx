...
export default function ThemeToggle() {
  ...
  const toggle = () => {
    ...
    try { localStorage.setItem("zenith-theme", next ? "dark" : "light"); } catch {}
    setDark(next);
  };
  ...
  return (
    <button
      ...
      className="grid h-9 w-9 place-items-center rounded-full border bd text-2 transition-colors hover:text-app"
